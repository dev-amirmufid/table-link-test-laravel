    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form method="POST" action="{{ route('admin.flights.update', $flight->id) }}">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="airline_name" name="airline_name" value="{{ $flight->airline_name }}"
            ...
            <div class="grid grid-cols-2 gap-4 mb-4">
                <div>
                    ...
                    <input type="text" id="departure_airport" name="departure_airport" value="{{ $flight->departure_airport }}"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                        required>
                ...
                <div>
                    ...
                    <input type="text" id="arrival_airport" name="arrival_airport" value="{{ $flight->arrival_airport }}"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                        required>
            ...
            <div class="grid grid-cols-2 gap-4 mb-4">
                <div>
                    ...
                    <input type="time" id="departure_time" name="departure_time" value="{{ \Carbon\Carbon::parse($flight->departure_time)->format('H:i') }}"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                        required>
                ...
                <div>
                    ...
                    <input type="number" id="price" name="price" value="{{ $flight->price }}"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                        required>
                    @error('price')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
            ...
            <div class="grid grid-cols-2 gap-4 mb-6">
                ...
                <div>
                    ...
                    <select id="class_type" name="class_type"
                        ...
                        <option value="first-class" {{ $flight->class_type === 'first-class' ? 'selected' : '' }}>First Class</option>
                    </select>
                </div>
            </div>
